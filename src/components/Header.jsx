...
import { UserContext, TokenContext, CountContext } from "../App";
import { useNavigate, Link, NavLink } from "react-router-dom";
import useLocalStorage from "../hooks/UseToLocalStorage";
...
function Header() {
  ...
  useEffect(() => {
    ...
    const totalCount = product.reduce((acc, el) => acc + el.count, 0);
    setCount(totalCount);
  }, [setCount]);
      ...
      <div className="navbar bg-base-200 mx-auto max-w-6xl ">
        <div className="container mx-auto">
          <div className="navbar-start">
            ...
            <Link
              to="/"
              className="btn bg-blue-600 rounded-xl text-2xl text-white"
            >
              C
            </Link>
          </div>
